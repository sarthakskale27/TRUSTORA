          ...
          setNotifications([
            {
              ...
              type: 'booking',
              title: 'New Reservation Confirmed',
              message: 'Rohit Verma booked Palolem Palm Resort (₹18,000) for upcoming dates.',
              time: '10 mins ago',
              read: false,
              icon: Calendar,
              color: 'emerald',
            ...
            },
            {
              ...
              type: 'payout',
              title: 'Direct Payout Credited',
              message: '₹36,000 net booking revenue disbursed to your linked account.',
              time: '2 hours ago',
              read: false,
              icon: DollarSign,
              color: 'teal',
            ...
            },
            {
              id: 'host-def-3',
              type: 'trust',
              title: 'Host Verification Verified',
              message: 'Your identity and biometric match are 100% active and verified.',
              time: '1 day ago',
              read: true,
              icon: ShieldCheck,
              color: 'indigo',
          ...
          setNotifications([
            {
              id: 'guest-def-1',
              type: 'booking',
              title: 'Trip Protection Active',
              message: 'Your reservations are protected by Trustora 100% money-back guarantee.',
              time: 'Just now',
              read: false,
              icon: ShieldCheck,
              color: 'emerald',
            ...
            },
            {
              id: 'guest-def-2',
              type: 'concierge',
              title: 'WhatsApp Concierge Ready',
              message: 'Connect with our 24/7 AI travel concierge for smooth check-ins.',
              time: '2 hours ago',
              read: true,
              icon: MessageSquare,
              color: 'teal',
